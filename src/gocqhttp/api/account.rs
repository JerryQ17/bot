...
use crate::{http_get_response, http_post_response, Result};
...
impl GoCqhttp {
    ...
    pub async fn get_login_info(&self) -> Result<LoginInfo> {
        let resp = self.get("get_login_info").await?;
    ...
    pub async fn get_model_show(&self, model: String) -> Result<ModelShowVariants> {
        let resp = http_get_response!(self, "_get_model_show", model);
        APIResponse::get_data_in_response(resp).await
    }
    ...
    pub async fn set_model_show(&self, model: String, model_show: String) -> Result<()> {
        let resp = http_post_response!(self, "_set_model_show", model, model_show);
        APIResponse::assert_ok_in_response(resp).await
    }
    ...
    pub async fn get_online_clients(&self, no_cache: bool) -> Result<ClientDevices> {
        let resp = http_get_response!(self, "_set_model_show", no_cache);
        APIResponse::get_data_in_response(resp).await
    }
}
